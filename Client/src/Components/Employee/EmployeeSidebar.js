...
const EmployeeSidebar = () => {
  ...
  return (
    ...
    <nav >
          <li><Link to="/EmployeeDashboard" className={splitLocation[1] === "EmployeeDashboard" ? "active nav-link" : 'nav-link'}><i className="fa-solid fa-bars ml-3"></i>Dashboard</Link></li>
          <li><Link to="/Projectlist" className={splitLocation[1] === "Projectlist" ? "active nav-link" : 'nav-link'}><i className="fa-solid fa-file"></i>Projects</Link></li>
          ...
          <li><Link to="/EmployeeTimeSheet" className={splitLocation[1] === "EmployeeTimeSheet" ? "active nav-link" : 'nav-link'}><i className="fa-solid fa-timeline"></i>Time Sheet</Link></li>
